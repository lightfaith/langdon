#!/usr/bin/python3
"""
Oracle for Cryptopals 4.25 - random access read/write AES CTR

Oracle takes plaintext input and encrypts it with static key 
and nonce, thus simulating read/write access.
"""
